...
cmd=["/data/BB_Bioinformatics/Kevin/tools/mtag/mtag.py --sumstats ../result/serosum_mtag.txt,../result/hbvsum_mtag.txt  --force --out ../result/mtag_hbvload_sero --n_min 0.0  --stream_stdout"]
subprocess.call(cmd,shell=True)
